package br.com.thiscode.authservice.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.com.thiscode.authservice.service.EmailAlreadyUsedException ||
            ex instanceof br.com.thiscode.authservice.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof br.com.thiscode.authservice.service.InvalidPasswordException
